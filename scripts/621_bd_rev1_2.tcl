...
################################################################
# This is a generated script based on design: pssub
#
...
if { $list_projs eq "" } {
   create_project moverlab myproj -part xczu9eg-ffvb1156-2-e
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ddr_reset_300, and set properties
  set ddr_reset_300 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ddr_reset_300 ]
  ...
  # Create instance: rx_stream, and set properties
  set rx_stream [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 rx_stream ]
  set_property -dict [ list \
  ...
  # Create instance: tx_stream, and set properties
  set tx_stream [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 tx_stream ]
  set_property -dict [ list \
   CONFIG.IS_ACLK_ASYNC {1} \
   CONFIG.TDATA_NUM_BYTES {8} \
 ] $tx_stream
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__ACT_FREQMHZ {26.664000} \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {199.980000} \
...
connect_bd_intf_net -intf_net tx_stream_M_AXIS [get_bd_intf_pins system_ila_0/SLOT_0_AXIS] [get_bd_intf_pins tx_stream/M_AXIS]
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins rx_stream/s_axis_tdata]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_smc/aclk] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins ddr_reset_300/slowest_sync_clk] [get_bd_pins rx_stream/m_axis_aclk] [get_bd_pins system_ila_1/clk] [get_bd_pins tx_stream/s_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins ddr_reset_300/ext_reset_in]
  connect_bd_net -net ddr4_0_c0_init_calib_complete [get_bd_ports init_calib_complete] [get_bd_pins ddr4_0/c0_init_calib_complete]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net reset_100_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins ddr_reset_300/peripheral_aresetn] [get_bd_pins rx_stream/m_axis_aresetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins tx_stream/s_axis_aresetn]
  connect_bd_net -net reset_100_peripheral_aresetn1 [get_bd_pins reset_100/peripheral_aresetn] [get_bd_pins rx_stream/s_axis_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins tx_stream/m_axis_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins irq_concat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins irq_concat_1/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  connect_bd_net -net xlconstant_high_dout [get_bd_pins rx_stream/s_axis_tvalid] [get_bd_pins tx_stream/m_axis_tready] [get_bd_pins xlconstant_high/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins reset_100/slowest_sync_clk] [get_bd_pins rx_stream/s_axis_aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins tx_stream/m_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins reset_200/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins reset_100/ext_reset_in] [get_bd_pins reset_200/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
